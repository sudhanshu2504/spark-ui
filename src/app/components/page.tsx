...
const Card = (component: any) => {
  ...
  return (
    <div className='flex flex-col gap-[1px] w-[450px] max-w-full cursor-pointer' onClick={()=>navigate(component.link)} onMouseEnter={()=>setIsHovered(true)} onMouseLeave={()=>setIsHovered(false)}>
