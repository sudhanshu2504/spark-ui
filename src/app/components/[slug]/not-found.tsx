...
export default function NotFound() {
  return (
    <div className="h-screen w-full bg-black flex items-center justify-center relative overflow-hidden font-secondary">
      {/* Grid background */}
      ...
      >
        <div className="backdrop-blur-xl bg-black/40 border border-white/10 rounded-2xl p-8 shadow-2xl text-center relative overflow-hidden group">
          ...
          >
            ...
            <div className="absolute inset-0 blur-3xl bg-purple-500/20 rounded-full -z-10" />
          </motion.div>
          ...
          <Link
            href="/components"
            className="inline-flex items-center gap-2 px-6 py-3 bg-white text-black rounded-full font-semibold hover:bg-gray-200 transition-colors duration-200 group/btn"
          >
