...
import CurvedNavbar from '@/app/components/curved-navbar/components/curved-navbar';
  ...
  return (
    ...
    <div className='h-auto w-full flex justify-around bg-black border-b'>
      ...
      <div className={`flex justify-end w-[45%]`}>
        <div onClick={() => {setIsActive(!isActive)}} className={`w-20 h-20 rounded-full flex flex-col items-center justify-center cursor-pointer`}>
